              ...
              <Col xs="12" className="col-sm p-0 h-100">
                <Card.Body className="ps-lg-0">
                  <div className="d-flex flex-row justify-content-between mb-2">
                    <div className="heading body-link mb-0">React Native</div>
                    <div className="text-muted">33%</div>
                  </div>
                  <ProgressBar className="progress-md mb-2" now={33} />
                  <Clamp tag="span" clamp="2" className="text-muted mb-2">
                    Improve your React skills and mobile development at the same time using react native
                  </Clamp>
          ...
          <Card>
            <Row className="g-0 h-auto sh-sm-23">
              ...
              <Col xs="12" className="col-sm p-0 h-100">
                <Card.Body className="ps-lg-0">
                  <div className="d-flex flex-row justify-content-between mb-2">
                    <div className="heading body-link mb-0">Data Structures and Algorthyms</div>
        ...
        <Col>
          <Card className="h-100">
            <Card.Body>
              ...
              <div className="text-muted text-center">Learn about them state mangement</div>
            </Card.Body>
          </Card>
        </Col>
        <Col>
