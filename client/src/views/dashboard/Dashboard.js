                ...
                <Card.Body className="scroll-out">
                  <OverlayScrollbarsComponent options={{ scrollbars: { autoHide: 'leave' }, overflowBehavior: { x: 'hidden', y: 'scroll' } }} className="h-100">
                    <Row className="g-0 sh-10 mb-3">
                      <Col className="col-auto">
                        <NavLink to="/products/detail">
                          <img src="/img/product/small/product-1.jpg" className="card-img rounded-md h-100 sw-8" alt="thumb" />
                        </NavLink>
                      </Col>
                      <Col>
                    ...
                    <Row className="g-0 sh-10 mb-3">
                      <Col className="col-auto">
                        <NavLink to="/products/detail">
                          <img src="/img/product/small/product-2.jpg" className="card-img rounded-md h-100 sw-8" alt="thumb" />
                        </NavLink>
                      </Col>
                      <Col>
                        <div className="d-flex flex-column pt-0 pb-0 ps-3 pe-0 h-100 justify-content-center">
                    ...
                    <Row className="g-0 sh-10 mb-3">
                      <Col className="col-auto">
                        <NavLink to="/products/detail">
                          <img src="/img/product/small/product-3.jpg" className="card-img rounded-md h-100 sw-8" alt="thumb" />
                        </NavLink>
                      </Col>
                      <Col>
                        <div className="d-flex flex-column pt-0 pb-0 ps-3 pe-0 h-100 justify-content-center">
                    ...
                    <Row className="g-0 sh-10 mb-3">
                      <Col className="col-auto">
                        <NavLink to="/products/detail">
                          <img src="/img/product/small/product-4.jpg" className="card-img rounded-md h-100 sw-8" alt="thumb" />
                        </NavLink>
                      </Col>
                      <Col>
                        <div className="d-flex flex-column pt-0 pb-0 ps-3 pe-0 h-100 justify-content-center">
          ...
          <div className="mb-n2">
            <Card className="mb-2">
              <Row className="g-0 sh-14 sh-md-10">
                <Col className="col-auto">
                  <NavLink to="/products/detail">
                    <img src="/img/product/small/product-1.jpg" alt="alternate text" className="card-img card-img-horizontal sw-11" />
                  </NavLink>
                </Col>
                <Col>
                  <Card.Body className="pt-0 pb-0 h-100">
            ...
            <Card className="mb-2">
              <Row className="g-0 sh-14 sh-md-10">
                <Col className="col-auto">
                  <NavLink to="/products/detail">
                    <img src="/img/product/small/product-2.jpg" alt="alternate text" className="card-img card-img-horizontal sw-11" />
                  </NavLink>
                </Col>
                <Col>
                  <Card.Body className="pt-0 pb-0 h-100">
            ...
            <Card className="mb-2">
              <Row className="g-0 sh-14 sh-md-10">
                <Col className="col-auto">
                  <NavLink to="/products/detail">
                    <img src="/img/product/small/product-3.jpg" alt="alternate text" className="card-img card-img-horizontal sw-11" />
                  </NavLink>
                </Col>
                <Col>
                  <Card.Body className="pt-0 pb-0 h-100">
            ...
            <Card className="mb-2">
              <Row className="g-0 sh-14 sh-md-10">
                <Col className="col-auto">
                  <NavLink to="/products/detail">
                    <img src="/img/product/small/product-4.jpg" alt="alternate text" className="card-img card-img-horizontal sw-11" />
                  </NavLink>
                </Col>
                <Col>
                  <Card.Body className="pt-0 pb-0 h-100">
