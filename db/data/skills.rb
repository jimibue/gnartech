...
def create_companies_and_jobs
  ...
  ####
  mx.jobs.create(title: "Back End Dev", description: "Back end job at MX", link: "https:google.com")
  mavenlink.jobs.create(title: "Front End Dev", description: "Front end job at MAven", link: "https:google.com")
  mavenlink.jobs.create(title: "back End Dev", description: "ack end job at Mavne", link: "https:google.com")
end
